            ...
            <footer className="relative z-10 pt-24 pb-12 bg-[#f6f3f0]">
              <div className="container mx-auto px-6 flex flex-col items-center">
                ...
                <div className="flex items-center gap-4 mb-16">
                  <a href="https://discord.gg/your-link" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-brand/15 text-brand/50 hover:text-brand hover:border-brand/40 transition-all duration-500 flex items-center justify-center" title="Discord">
                  ...
                  <a href="https://x.com/your-account" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-brand/15 text-brand/50 hover:text-brand hover:border-brand/40 transition-all duration-500 flex items-center justify-center" title="X (Twitter)">
